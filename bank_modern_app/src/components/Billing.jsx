  ...
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-2-[470px] mt-5`}>
        My name is Ryu Pradana, I am a fourth-year high school student from
        Cawthra Park secondary school. I am an aspiring computer science student
        and software developer/engineer.
      </p>
